...
## Development environment and release process
 ...
 - create virtualenv with Flask and e-shvArts installed into it (latter is installed in
...
install it (`pip install hseling_api_e_shvarts.tar.gz`), ensure that configuration file exists and
`HSELING_API_E_SHVARTS_SETTINGS` environment variable points to it, ensure that user has access to the
